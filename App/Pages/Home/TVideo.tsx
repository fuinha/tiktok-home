  ...
  render() {
    ...
    return (
      <View style={ps.container}>
        ...
        />
        <TouchableOpacity style={[StyleSheet.absoluteFill, ps.center]} onPress={video.onPause}>
          {video.paused && (
            <Image style={homeStyle.playButton} source={require("../../../Assets/play.png")} />
          )}
        </TouchableOpacity>
        <View style={homeStyle.fabContainer}>
          <TouchableOpacity onPress={home.onCommentOpen}>
            <Image style={homeStyle.fabButton} source={require("../../../Assets/message.png")} />
          </TouchableOpacity>
        </View>
